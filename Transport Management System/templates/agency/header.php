...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Agency - Transport Management System</title>
        ...
        <div class="page-container">
          <div class="page-sidebar">
            ...
            <ul class="list-unstyled accordion-menu">
              ...
              <li>
                <a href="view_req.php"><i class="fas fa-eye"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; View Request</a>
              </li>

              <li>
                <a href="status.php"><i class="fas fa-truck"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Status</a>
              </li>
